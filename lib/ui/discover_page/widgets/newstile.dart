...
//    const NewsListTile({super.key, required this.title, required this.category, required this.image, required this.publishedat, required this.author,required this.orientation});
//
//   final String title ;
...
//       // height: or0.15.sh,
//       height: orientation == Orientation.portrait ? 0.15.sh :100.h,
...
//                 Text(title,style: fontStyle(16.sp, Colors.black87, FontWeight.w600),),
//                 const SizedBox(height: 5,),
//                 Row(
//                   mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                   children: [
//                     Text(author,style:fontStyle(12.sp, Colors.black45, FontWeight.w500)),
//                     //Add a Black Centered Dot between Author and Published At
//                     CircleAvatar(radius: 2,backgroundColor: Colors.black45,),
//                     // const SizedBox(width: 5,),
//                     Text(publishedat,style: fontStyle(12.sp, Colors.black45, FontWeight.w500)),
//                   ],
//                 ),
//               ],
//             ),
...
//             ? 0.15.sh
//             : textHeight + 60; // Add some extra space for other elements
//
//         return Container(
//           margin: EdgeInsets.only(bottom: 10),
//           padding: EdgeInsets.all(10),
